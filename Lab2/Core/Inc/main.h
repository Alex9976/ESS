...
#define BTN_SPEED_UP_Pin GPIO_PIN_4
#define BTN_SPEED_UP_GPIO_Port GPIOA
#define BTN_SPEED_UP_EXTI_IRQn EXTI4_IRQn
...
#define BTN_SPEED_DOWN_Pin GPIO_PIN_0
#define BTN_SPEED_DOWN_GPIO_Port GPIOB
#define BTN_SPEED_DOWN_EXTI_IRQn EXTI0_IRQn
